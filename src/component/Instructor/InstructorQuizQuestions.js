...
const handleGenerateQuiz = () => {
  navigate(`/instructor/courses/${courseId}/quiz-builder?quizId=${quizId}`);
};


  return (
    <div style={{ display: "grid", gap: 16, minHeight: "100vh", padding: 20, background: "#f8fafc" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12, flexWrap: "wrap", maxWidth: 900, margin: "0 auto", width: "100%" }}>
        <div>
          <div style={{ fontSize: 13, color: "#64748b" }}>Instructor / Courses / Quiz / Questions</div>
          <h1 style={{ margin: 0, fontSize: 22, fontWeight: 950, color: "#0f172a" }}>
            {quiz ? quiz.title : "Quiz"}
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <button onClick={handleGenerateQuiz} style={btnAI}>
      ...
      {error && <div style={{...errBox, maxWidth: 900, margin: "0 auto", width: "100%"}}>{error}</div>}

      {/* Create Question Manually */}
      <div style={{...card, maxWidth: 900, margin: "0 auto", width: "100%"}}>
        <div style={{ fontWeight: 950, color: "#0f172a" }}>Add Question Manually</div>
        <div style={{ display: "grid", gap: 12, marginTop: 12 }}>
          <div style={field}>
            <div style={label}>Question text</div>
            <input
          ...
          <button onClick={(e) => { e.preventDefault(); submit(e); }} style={btnPrimary}>
            + Save Question
          </button>
        </div>
      </div>
      ...
      <div style={{...card, maxWidth: 900, margin: "0 auto", width: "100%"}}>
        ...
        {questions.length === 0 ? (
          <div style={{ marginTop: 12, padding: 14, borderRadius: 14, background: "rgba(15,23,42,0.03)", border: "1px dashed rgba(15,23,42,0.15)", textAlign: "center" }}>
...
/* styles */
const card = { background: "#fff", borderRadius: 18, border: "1px solid rgba(15,23,42,0.08)", boxShadow: "0 18px 40px rgba(15,23,42,0.06)", padding: 16 };
const input = { padding: 12, borderRadius: 12, border: "1px solid rgba(15,23,42,0.12)", outline: "none", background: "#fff", fontSize: 14 };
const label = { fontSize: 12, fontWeight: 900, color: "#0f172a" };
const field = { display: "grid", gap: 6 };
const ansRow = { display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" };
const btnPrimary = { padding: "10px 12px", borderRadius: 12, border: "none", cursor: "pointer", background: "linear-gradient(135deg,#2d8cff,#1b64ff)", color: "#fff", fontWeight: 950, fontSize: 14 };
const btnAI = { padding: "10px 16px", borderRadius: 12, border: "none", cursor: "pointer", background: "linear-gradient(135deg,#8b5cf6,#7c3aed)", color: "#fff", fontWeight: 950, fontSize: 14, display: "flex", alignItems: "center", gap: 6 };
const btnSoft = { padding: "10px 16px",marginTop:"10px", borderRadius: 12, background: "#f1f5f9", border: "1px solid rgba(15,23,42,0.08)", color: "#0f172a", textDecoration: "none", fontWeight: 850, fontSize: 14, display: "inline-block" };
const errBox = { padding: 12, borderRadius: 14, background: "rgba(244,63,94,0.08)", border: "1px solid rgba(244,63,94,0.25)", color: "#be123c", fontWeight: 800 };
const qCard = { padding: 14, borderRadius: 16, border: "1px solid rgba(15,23,42,0.08)", background: "linear-gradient(180deg,#fff,#fbfdff)" };